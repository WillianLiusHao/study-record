...
`Qiankun + Monorepo + Vue3 + Tsx + Element-Plus`
...
| 类型 | 结构 |
| ---- | ---- |
| 当前常规前端工程 | `文件职能-功能模块`结构，即`组件、素材、状态、路由`等文件职能统一管理|
| Elux工程 | `功能模块-文件职能`结构，文件职能由功能模块自己管理 |
...
- 从产品上讲，微模块为了能更好的复用**业务功能**，更便于功能的自由组合使用
- 从开发上讲，微模块聚合了某一**特定的业务场景**功能（有单独的api,assets,utils,view等），独立自治，是可以独立运转的小系统
